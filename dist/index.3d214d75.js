...
})({"iPWA1":[function(require,module,exports) {
...
window.addEventListener("load", ()=>{
    if (sessionStorage.getItem("premierChargement") === null) loader.classList.add("fondu-out");
...
const headerDownObserver = new IntersectionObserver(function(entries, headerDownObserver) {
    entries.forEach((entry)=>{
        if (entry.isIntersecting) headerDown.classList.add("header-white");
    });
}, headerDownOptions);
headerDownObserver.observe(projects__target);

},{}]},["iPWA1","bB7Pu"], "bB7Pu", "parcelRequire2041")
