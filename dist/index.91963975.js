        ...
        t.exports = {
            polyfill: function() {
                ...
                if (!("scrollBehavior" in e.documentElement.style) || !0 === t.__forceSmoothScrollPolyfill__) {
                    ...
                    }, o = t.performance && t.performance.now ? t.performance.now.bind(t.performance) : Date.now, r = (i = t.navigator.userAgent, new RegExp([
                        "MSIE ",
                        "Trident/",
                        "Edge/"
                    ].join("|")).test(i) ? 1 : 0);
    ...
    var tt = function(t, e, i, s) {
        ...
        function r(e) {
            ...
            return l >= .001 ? function(t, e, i, s) {
                ...
                var o, r, l = 0;
                do (o = J(r = e + (i - e) / 2, s, n) - t) > 0 ? i = r : e = r;
            ...
            },
            {
                ...
                value: function(t) {
                    var e = this, i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, s = parseInt(i.offset) || 0, n = isNaN(parseInt(i.duration)) ? 1e3 : parseInt(i.duration), o = i.easing || [
                        ...
                        .35,
                        1
                    ], r = !!i.disableLerp, l = !!i.callback && i.callback;
...
//# sourceMappingURL=index.91963975.js.map
